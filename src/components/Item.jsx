...
const Item = ({id, data}) => {
	...
	const frontFace = {
		backfaceVisibility: (flipped ? "unset" : "hidden")
	}

	return (
		<IonCol size="6">
			<IonCard className={"ion-activatable ripple-parent card" + (flipped ? " is-flipped" : "")} style={{boxShadow: "none", margin: 0, paddingBottom: "152%"}}
